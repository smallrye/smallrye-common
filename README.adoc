image:https://github.com/smallrye/smallrye-common/workflows/SmallRye%20Common%20CI/badge.svg[SmallRye Common CI, link="https://github.com/smallrye/smallrye-common/workflows/SmallRye%20Common%20CI"]
